...
REM Subdirectoare pentru components
mkdir components\ui 2>nul
mkdir components\FuelRequestApp 2>nul
mkdir components\figma 2>nul

REM Directoare pentru documentație
mkdir "Kit instalare Manager" 2>nul
mkdir "Kit instalare Manager\Aplicația_Evidenta_Cheltuieli" 2>nul
mkdir "Kit instalare Manager\Backup_si_Export" 2>nul

REM Directoare pentru surse alternative
mkdir src 2>nul
